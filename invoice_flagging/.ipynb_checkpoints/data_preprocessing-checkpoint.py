...
def load_invoice_data():
    conn = sqlite3.connect("/Users/hp/Downloads/inventory.db")
    ...
    SELECT
        ...
        vi.Freight,
        (julianday(vi.InvoiceDate) - julianday(vi.PODate)) AS days_po_toinvoice,
...
def scale_features(X_train, X_test, scaler_path):
    ...
    X_test_scaled = scaler.transfer(X_test)
